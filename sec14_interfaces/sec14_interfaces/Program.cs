...
namespace Sec14
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            StartTemp = DateTime.ParseExact(Console.ReadLine(), "dd/MM/yyyy HH:mm", CultureInfo.CurrentCulture);
            Console.Write("Finish (dd/MM/yyyy hh:mm): ");
            ReturnTemp = DateTime.ParseExact(Console.ReadLine(), "dd/MM/yyyy HH:mm", CultureInfo.CurrentCulture);
